...
export const fetchArchiveOrgGames = async (collectionUrl: string): Promise<RemoteGame[]> =>
...
export const downloadRemoteIsoWithProgress = async (
  ...
  invoke('download_remote_iso_with_progress', { downloadUrl, destinationFolder, fileName })
