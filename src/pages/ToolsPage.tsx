...
import { BinCueConverter, CddaDetector, DownloadQueue, FeatureCard } from '../components'
import { useSourceContext } from '../contexts/SourceContext'

export const ToolsPage = () => {
  const { libraryRoot } = useSourceContext()
  const [activeTab, setActiveTab] = useState<'queue' | 'converter' | 'cdda' | null>(null)
  
  return (
    <div style={{ padding: '20px' }}>
      <h1 style={{ marginBottom: '24px' }}>🛠️ Tools & Utilities</h1>
      ...
      <div className="feature-grid" style={{ marginBottom: '32px' }}>
        ...
        <FeatureCard
          ...
          onClick={() => setActiveTab(activeTab === 'converter' ? null : 'converter')}
        />
